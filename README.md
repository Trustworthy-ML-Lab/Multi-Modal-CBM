...
* This is our official repo of **Multi-Modal Concept Bottleneck Models (MM-CBMs)**. MM-CBM is a new framework to transform multi-modal models such as CLIP into fully interpretable models with human-friendly concepts while preserving zero-shot ability. 
